...
class ParserModel(Model):
    ...
    def add_placeholders(self):
        ...
        """
        ### YOUR CODE HERE
        self.input_placeholder = tf.placeholder(tf.int32,(None,self.config.n_features),name='input_placeholder')
        self.labels_placeholder = tf.placeholder(tf.float32,(None,self.config.n_classes),name='labels_placeholder')
    ...
    def add_embedding(self):
        ...
        """
        ### YOUR CODE HERE
        embedding_model = tf.get_variable('Embedding',initializer=self.pretrained_embeddings)
        embeddings = tf.nn.embedding_lookup(embedding_model,self.input_placeholder)
    ...
    def add_loss_op(self, pred):
        ...
        """
        ### YOUR CODE HERE
        pred = tf.nn.softmax_cross_entropy_with_logits(pred,self.labels_placeholder)
